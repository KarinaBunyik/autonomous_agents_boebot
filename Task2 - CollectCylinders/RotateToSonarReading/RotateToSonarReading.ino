...
////////////  Variables  /////////////////////////////////////////////////////
double sonarReading = 0;
double newSonarReading = 0;
double sonarDecay = 0.5;
int currState = 0;
int iteration = 0;
...
void loop()
{
  ...
  newSonarReading = (1-sonarDecay)*sonarReading + sonarDecay*double(cm);
    
  if(newSonarReading > sonarReading && sonarReading < 100) {
    if(currState == 0) {
      currState = 1;
    }
    else {
